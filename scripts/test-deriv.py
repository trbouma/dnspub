...
mnemonic = "angry ridge sad engine crawl blind ankle stock spot drink mom identify"
...
print(f"bip32 master: {master_privkey_hex} nsec {privkey_hex_to_nsec(master_privkey_hex)} pubkey hex: {master_pubkey_hex} npub{pubkey_hex_to_npub(master_pubkey_hex)}")
...
privkey_path =  "m/44/1237"
pubkey_path =   "M/44/1237"
...
print("let's try some conversions:")
